...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Public\\LAB PROJECTS\\Chein-Lab\\LITe\\planetGoNoGo\\PlanetGoNoGo_scan_update0613 - Copy_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    # Run 'Begin Experiment' code from backupcsv_creation
    import os
    
    folder_name = "C:\Users\Public\LAB PROJECTS\Chein-Lab\LITe\planetGoNoGo\Data\backup"
    ...
    datafile = os.path.join(
        folder_name,
        os.path.basename(filename) + "_backup.csv"
    )
    # Run 'Begin Experiment' code from forcesave_backup
    ...
    # Run 'End Routine' code from forcesave_backup
    thisExp.saveAsWideText(
        datafile,
        fileCollisionMethod='overwrite'
    )
