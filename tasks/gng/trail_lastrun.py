...
expName = 'trail'  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\tur31606\\Desktop\\gng\\trail_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    image_left = visual.ImageStim(
        win=win,
        name='image_left', 
        image='C:/Users/tur31606/Pictures/player1.jpg', mask=None, anchor='center',
    ...
    image_right = visual.ImageStim(
        ...
        name='image_right', 
        image='C:/Users/tur31606/Pictures/player1.jpg', mask=None, anchor='center',
        ori=0.0, pos=(o.4, 0), size=(0.5, 0.5),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
    ...
    trialComponents = [text, image_left, image_right]
    ...
    while continueRoutine and routineTimer.getTime() < 3.0:
        ...
        # if image_left is stopping this frame...
        if image_left.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > image_left.tStartRefresh + 3.0-frameTolerance:
                # keep track of stop time/frame for later
        ...
        # if image_right is stopping this frame...
        if image_right.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > image_right.tStartRefresh + 3.0-frameTolerance:
                # keep track of stop time/frame for later
