...
function image3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of image3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function image4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of image4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function text7RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of text7Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function text8RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of text8Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function waitForScannerRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of waitForScannerComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trial_cueRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of trial_cueComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function runEndRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of runEndComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
