var jsPsychSurveyText = (function (jspsych) {
  ...
  const info = {
      ...
      parameters: {
          ...
          trial_duration: {
           ...
           percentage_check: {
             type: jspsych.ParameterType.BOOL,
             pretty_name: 'Percentage Check',
             default: false,
             description: 'Confirms that sum of each question adds to 100.'
             }, // this is the parameter I added as mentioned in this post.
        }
  };
  /**
  ...
  class SurveyTextPlugin {
      ...
      trial(display_element, trial) {
          ...
          //adapted by SM for trial duration purposes. This will let me hide the next button for as long as the 'trial_duration:' indicates
