var jsPsychSurveyMultiChoice = (function (jspsych) {
  ...
  class SurveyMultiChoicePlugin {
      ...
      trial(display_element, trial) {
          ...
          html +=
              ".jspsych-survey-multi-choice-question { font-size:2.7vw; margin-top: 2em; margin-bottom: 2em; text-align: left; }" +
                  ".jspsych-survey-multi-choice-text span.required {color: darkred;}" +
                  ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-text {  text-align: center;}" +
                  ".jspsych-survey-multi-choice-option { line-height: 2; }" +
                  ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-option {  display: inline-block;  margin-left: 2em;  margin-right: 2em;  vertical-align: top;}" +
