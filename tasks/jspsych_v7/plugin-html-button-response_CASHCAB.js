var jsPsychHtmlButtonResponse = (function (jspsych) {
  ...
  class HtmlButtonResponsePlugin {
      ...
      trial(display_element, trial) {
          ...
          // store response
          var response = {
              rt: [], //changed from "null" to "[]" -- SM 04/17/2024
              button: [], //changed from "null" to "[]" -- SM 04/17/2024
              test: [],
          };
          ...
          const end_trial = () => {
              ...
              var trial_data = {
                  ...
                  response: JSON.stringify(response.button),
              };
              // clear the display
          ...
          function after_response(choice) {
              ...
              var reaction_time = Math.round(end_time - start_time); // changed from "rt" to "reaction_time" -- SM 04/17/2024
              // response.button = parseInt(choice); // commented out -- SM (04/17/2024)
                 response.button.push(parseInt(choice));
              // response.rt = rt; // commented out -- SM (04/17/2024)
                 response.rt.push(reaction_time);
            ...
            //       " responded";
              ...
              for (var i = 0; i < btns.length; i++) {
                  ...
                  btns[i].removeAttribute("disabled", "disabled"); //Changed from "setAttribute" to "remove Attribute" in order to enable multiple button presses
              }
