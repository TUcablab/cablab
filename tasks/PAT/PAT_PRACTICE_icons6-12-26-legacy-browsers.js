...
function ChoiceRoutine_1RoutineBegin(snapshot) {
  return async function () {
    ...
    ChoiceRoutine_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Player1_1RoutineBegin(snapshot) {
  return async function () {
    ...
    Player1_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function topyesp1RoutineBegin(snapshot) {
  return async function () {
    ...
    topyesp1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Player2_1RoutineBegin(snapshot) {
  return async function () {
    ...
    Player2_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function topyesp2RoutineBegin(snapshot) {
  return async function () {
    ...
    topyesp2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ChoiceRoutine_2RoutineBegin(snapshot) {
  return async function () {
    ...
    ChoiceRoutine_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Play1_2RoutineBegin(snapshot) {
  return async function () {
    ...
    Play1_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function topnop1RoutineBegin(snapshot) {
  return async function () {
    ...
    topnop1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function play2_2RoutineBegin(snapshot) {
  return async function () {
    ...
    play2_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function topnop2RoutineBegin(snapshot) {
  return async function () {
    ...
    topnop2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function wait_2RoutineBegin(snapshot) {
  return async function () {
    ...
    wait_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ChoiceRoutine_3RoutineBegin(snapshot) {
  return async function () {
    ...
    ChoiceRoutine_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function player1_3RoutineBegin(snapshot) {
  return async function () {
    ...
    player1_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function topnsp1RoutineBegin(snapshot) {
  return async function () {
    ...
    topnsp1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function player2_3RoutineBegin(snapshot) {
  return async function () {
    ...
    player2_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function topnsp2RoutineBegin(snapshot) {
  return async function () {
    ...
    topnsp2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function wait_3RoutineBegin(snapshot) {
  return async function () {
    ...
    wait_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ChoiceRoutine_4RoutineBegin(snapshot) {
  return async function () {
    ...
    ChoiceRoutine_4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function player1_4RoutineBegin(snapshot) {
  return async function () {
    ...
    player1_4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function topyesp1_2RoutineBegin(snapshot) {
  return async function () {
    ...
    topyesp1_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function topyesp2_2RoutineBegin(snapshot) {
  return async function () {
    ...
    topyesp2_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ChoiceRoutine_5RoutineBegin(snapshot) {
  return async function () {
    ...
    ChoiceRoutine_5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Play1_4RoutineBegin(snapshot) {
  return async function () {
    ...
    Play1_4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function topnop1_2RoutineBegin(snapshot) {
  return async function () {
    ...
    topnop1_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function play2_4RoutineBegin(snapshot) {
  return async function () {
    ...
    play2_4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function topnop2_2RoutineBegin(snapshot) {
  return async function () {
    ...
    topnop2_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function wait_4RoutineBegin(snapshot) {
  return async function () {
    ...
    wait_4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ChoiceRoutine_6RoutineBegin(snapshot) {
  return async function () {
    ...
    ChoiceRoutine_6Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function player1_5RoutineBegin(snapshot) {
  return async function () {
    ...
    player1_5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function topnsp1_2RoutineBegin(snapshot) {
  return async function () {
    ...
    topnsp1_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function player2_5RoutineBegin(snapshot) {
  return async function () {
    ...
    player2_5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function topnsp2_2RoutineBegin(snapshot) {
  return async function () {
    ...
    topnsp2_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function wait_5RoutineBegin(snapshot) {
  return async function () {
    ...
    wait_5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ChoiceRoutineRoutineBegin(snapshot) {
  return async function () {
    ...
    ChoiceRoutineComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function player1RoutineBegin(snapshot) {
  return async function () {
    ...
    player1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function top1_neededit_nspRoutineBegin(snapshot) {
  return async function () {
    ...
    top1_neededit_nspComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function player2RoutineBegin(snapshot) {
  return async function () {
    ...
    player2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function top2_neededit_nspRoutineBegin(snapshot) {
  return async function () {
    ...
    top2_neededit_nspComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
