...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/avidachs/Desktop/Cablab/Delay Discounting/DD_alone/task_folder/DelayDiscountingTitrated_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        trialComponents = [key_resp, debug, which_text, or_text]
