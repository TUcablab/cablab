var jsPsychSurveyLikert = (function (jspsych) {
  ...
  class SurveyLikertPlugin {
      ...
      trial(display_element, trial) {
          ...
          html +=
              ".jspsych-survey-likert-statement { display:block; font-weight: normal; font-size: 40px; padding-top: 110px; margin-bottom: 70px; }" +
                  ".jspsych-survey-likert-opts { list-style:none; width:" +
                  w +
                  "; margin:auto; padding:0 0 35px; display:block; font-size: 25px; line-height:.8em; }" +
                  ".jspsych-survey-likert-opt-label { line-height: 2.7em; color: #444; }" + //
                  ".jspsych-survey-likert-opts:before { content: ''; position:relative; top:11px; /*left:9.5%;*/ display:block; background-color:#A9A9A9; height:4px; width:100%; }" + //changed from #efefef to ##000000 (05/17/2024)
