...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Public\\Documents\\cablab\\tasks\\PAT\\stimuli\\PAT_v2_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    yes1 = visual.ImageStim(
        win=win,
        name='yes1', 
        image='feedback/Thumbs_up.png', mask=None, anchor='center',
    ...
    for thisTrial in trials:
        ...
        Player2demo.setImage(face)
        cooking.setImage(interest1_img)
        text_4.setText(interest1
        
        )
        movies.setImage(interest2_img)
        text_5.setText(interest3)
        dancing.setImage(interest3_img)
        text_6.setText(interest2
        )
        fashion.setImage(interest1_img)
        text_7.setText(interest1
        )
        movie.setImage(interest1_img)
        text_8.setText(interest2)
        writing.setImage(interest1_img)
        text_9.setText(interest3
        )
        key_resp.keys = []
        key_resp.rt = []
        _key_resp_allKeys = []
