...
#in template save as: L3_template_task-go_model-H3_n95.fsf

MAINOUTPUT=${maindir}/derivatives/fsl/L3_task-${task}_model-${model}_${REPLACEME}_n${N} # for nppi
...
#OUTPUT=${MAINOUTPUT}/L3_task-${task}_${REPLACEME}_cnum-${cnum_pad}_cname-${copename}_3group
...
#	 create template and run FEAT analyses
	ITEMPLATE=${maindir}/templates/L3_template_task-${task}_model-${model}_n${N}.fsf  #1group template
#ITEMPLATE=${maindir}/templates/L3_template_task-${task}_model-${model}_n${N}_3group.fsf # 3group template
	
	OTEMPLATE=${MAINOUTPUT}/L3_task-${task}_${REPLACEME}_copenum-${copenum}.fsf
#OTEMPLATE=${MAINOUTPUT}/L3_task-${task}_${REPLACEME}_copenum-${copenum}_3group.fsf	
